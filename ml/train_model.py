...
class MLTradingTrainer:
    def __init__(self, dataset_path, selected_features=None, n_estimators=100,
                 ...
                 auto_select: bool = True, max_features: int = 60,
    ...
    def load_and_prepare_data(self):
        ...
        if self.selected_features is None:
            ...
            exclude_cols = ['datetime', 'timestamp', 'open_time',
...
if __name__ == "__main__":
    ...
    logger.info("Entrenamiento completado! Thresholds: LONG=%s, SHORT=%s", trainer.best_threshold_long, trainer.best_threshold_short)
